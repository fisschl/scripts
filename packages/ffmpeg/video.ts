...
export const prepareFFmpegExecutable = async () => {
  // 检查FFmpeg是否已存在
  if (existsSync(FFMPEG_PATH) && existsSync(FFPROBE_PATH)) return;
